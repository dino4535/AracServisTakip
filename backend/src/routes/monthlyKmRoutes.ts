...
import { getMonthlyKm, saveMonthlyKm, getVehicleKmHistory, importMonthlyKm, getMissingMonthlyKm } from '../controllers/monthlyKmController';
...
router.get('/missing', getMissingMonthlyKm);
